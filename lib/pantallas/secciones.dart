  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () => editarSeccion(context, negocio, null),
      ),
      body: ListView.builder(
        ...
        itemBuilder: (_, i) {
          ...
          return ListTile(
            ...
            onTap: () => editarSeccion(context, negocio, s),
...
/// Crea (s == null) o renombra una sección. Devuelve la sección guardada.
Future<Seccion?> editarSeccion(BuildContext context, Negocio negocio, Seccion? s) async {
  ...
  return negocio.guardarSeccion(nombre, id: s?.id);
}
